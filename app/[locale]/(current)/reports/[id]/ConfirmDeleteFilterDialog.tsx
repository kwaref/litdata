...
// interface ConfirmDeleteFilterDialog {}
...
export const CONFIRM_DELETE_FILTER_DIALOG = 'confirm-delete-filter-dialog'

function ConfirmDeleteFilterDialog() {
  const {isOpen, closeDialog, payload} = useDialog(CONFIRM_DELETE_FILTER_DIALOG)
  ...
  const handleOnDelete = async () => {
    ...
    setIsDeleting(false)
    closeDialog()
    toast.success(t(`DeleteDialog.toast-delete`))
  }
